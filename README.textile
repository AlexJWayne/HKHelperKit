...
h3. UINavigationController

* Added <tt>backViewController</tt> read only property that works just like <tt>topViewController</tt> except it return the controller immedaitely preceding the top one (or nil).